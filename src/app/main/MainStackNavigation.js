  ...
  return {
    ...
    tabBarIcon: ({focused}) => {
      if (route.name == 'Home') {
        ...
        return (
          <Image
            source={require('../../../assets/images/ic_home_default.png')}
          />
        );
          ...
          return (
            <View>
              ...
              <Text style={styles.Cart}>
                {cart.reduce((total, item) => total + item.number, 0)}
              </Text>
            </View>
          );
        }
        return (
          <View>
            <Image
              source={require('../../../assets/images/ic_cart_default.png')}
            />
            <Text style={styles.Cart}>
              {cart.reduce((total, item) => total + item.number, 0)}
            </Text>
        ...
        return (
          <Image
            source={require('../../../assets/images/ic_favorite_default.png')}
          />
        );
        ...
        return (
          <Image
            source={require('../../../assets/images/ic_notification_default.png')}
          />
        );
      }
    },
